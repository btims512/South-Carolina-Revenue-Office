        ...
        <div className="pl-24 pr-24 pt-8 pb-8">
          ...
          <div className="link-box flex underline text-[#0074c1] gap-[25px]">
            <div className="links flex flex-col pt-10 gap-6">
              <a href="#" className="text-[#0074c1] font-medium">
          ...
          <div>
            <div className="section-x2 flex justify-between gap-[40px]">
              ...
              <div className="section-2 w-[300px]">
                ...
                <div className="link-box flex text-[#0074c1] gap-[25px] pb-14">
                  <div className="links flex flex-col pt-10 gap-6">
                    <div className="flex">
                      <div>
                        <div class="sc-event-condensed__date">
                          <div class="sc-event-condensed__date-month">
                            <div class="block block-layout-builder block-field-blocknodeeventfield-date">
                              <div class="field field--field-date field--visually-hidden">
                                <div class="field__label visually-hidden">
                                  Date
                                </div>
                                <div class="field__item font-bold">Mar</div>
                              </div>
                            </div>
                          </div>
                          <div class="sc-event-condensed__date-day">
                            <div class="block block-layout-builder block-field-blocknodeeventfield-date">
                              <div class="field field--field-date field--visually-hidden">
                                <div class="field__label visually-hidden">
                                  Date
                                </div>
                                <div class="field__item font-bold">21</div>
                              </div>
                            </div>
                          </div>
                          <div class="sc-event-condensed__date-year">
                            <div class="block block-layout-builder block-field-blocknodeeventfield-date">
                              <div class="field field--field-date field--visually-hidden">
                                <div class="field__label visually-hidden">
                                  Date
                                </div>
                                <div class="field__item font-bold">2023</div>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="sc-event-condensed__date-day">
                            <div class="block block-layout-builder block-field-blocknodeeventfield-date">
                              <div class="field field--field-date field--visually-hidden">
                                ...
                                <div class="field__item font-bold">23</div>
                              </div>
                            </div>
                          </div>
                          <div class="sc-event-condensed__date-year">
                          ...
                          <div class="sc-event-condensed__date-day">
                            <div class="block block-layout-builder block-field-blocknodeeventfield-date">
                              <div class="field field--field-date field--visually-hidden">
                                ...
                                <div class="field__item font-bold">24</div>
                              </div>
                            </div>
                          </div>
                          <div class="sc-event-condensed__date-year">
