...
const MenuIcon = ({ isOpen }) => (
  <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-around', height: '1.5rem', boxShadow: 'none' }}>
    <div
      style={{
        width: '2rem',
        height: '0.2rem',
    ...
    <>
      <MDBNavbar>
        <MDBContainer fluid className='justify-start align-start'>
          ...
          <HiMagnifyingGlass size={24} strokeWidth={2} className="custom-icon"/>
          </div>
        </MDBContainer>
      </MDBNavbar>
